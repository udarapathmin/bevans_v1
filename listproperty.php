...
<html lang="en">
  <head>
    ...
    <title>List of all Property</title>
    ...
    <div class="row">
      ...
      <div class="col-md-9">
          ...
          <?php
            if(isset($_GET["delete"]) && $_GET["delete"] == 'true' ) {
              ...
              <div class="alert alert-success alert-dismissible" role="alert">
                ...
                <strong>Success!</strong><?php echo ' Deleted property record' ; ?> 
              </div>
        ...
        <div class="panel panel-default">
          <div class="panel-heading"><h3 class="panel-title">List of Property without Agents</h3></div>
          <div class="panel-body">
              <script type="text/javascript">
                ...
                <table id="example" class="table table-hover">
                        ...
                        <tbody>
                        <?php
                        $sql="SELECT * FROM realestateproperty WHERE agentid IS NULL";
