...
<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
  ...
  <div class="panel panel-default">
    ...
    <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
        <ul class="list-group">
          <li class="list-group-item"><a href='<?php echo $baseurl . "addadmin.php" ?>'>Advance Search</a></li>
          <li class="list-group-item"><a href='<?php echo $baseurl . "listadmin.php" ?>'>Search</a></li>
          <li class="list-group-item"><a href='<?php echo $baseurl . "pendingagents.php" ?>'>Saved Search</a></li>
        </ul>
    </div>
  </div>
  <div class="panel panel-default">
    ...
    <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
       <ul class="list-group">
          ...
          <li class="list-group-item"><a href='<?php echo $baseurl . "pendingagents.php" ?>'>Schedule Inspection</a></li>
        </ul>
    </div>
  </div>
</div>