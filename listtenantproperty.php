...
<html lang="en">
  <head>
    ...
    <title>List Tenant Property</title>
          ...
          <div class="panel-body">
              <script type="text/javascript">
                ...
                <table id="example" class="table table-hover">
                        ...
                        <tbody>
                        <?php
                        $sql="SELECT * FROM realestateproperty WHERE ownerid = '$customerid'";
                        ...
                        while($row = mysqli_fetch_array($result)){
                            ...
                            echo "<td>" . PHP_EOL; ?>
                            <a href='<?php echo $baseurl . 'tenantproperty.php?id='. $row['propertyid']; ?>' class='btn btn-primary btn-xs'><i class="fa fa-eye"></i></a>
                        <?php
                            echo "</td>" . PHP_EOL;
                            echo "</tr>" . PHP_EOL;
                        }
