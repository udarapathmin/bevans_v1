        ...
        <?php
            if(isset($_GET["save"]) && $_GET["save"] == 'true' ) {
              ...
              <div class="alert alert-success alert-dismissible" role="alert">
                ...
                <strong>Success!</strong><?php echo ' Property Saved for Profile' ; ?> 
              </div>
          ...
          <?php
            if(isset($_GET["save"]) && $_GET["save"] == 'false' ) {
              ...
              <div class="alert alert-danger alert-dismissible" role="alert">
                <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <strong>Error!</strong><?php echo ' Failed to Save record. You may have already saved this Property' ; ?> 
              </div>
        ...
        <script type="text/javascript">
                ...
                <table id="example" class="table table-hover">
                        ...
                        <?php
                            echo "</td>" . PHP_EOL;
                             echo "<td>" . PHP_EOL; ?>
                            <a href='<?php echo $baseurl . 'formaction/save_search_action.php?id='. $row['propertyid']; ?>' class='btn btn-primary btn-xs'><i class="fa fa-save"></i></a>
                        <?php
                            echo "</td>" . PHP_EOL;
                            echo "</tr>" . PHP_EOL;
                        }
